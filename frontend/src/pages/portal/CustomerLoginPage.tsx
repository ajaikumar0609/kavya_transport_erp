...
export default function CustomerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const result = await customerPortalService.login(email.trim());
      ...
      navigate('/portal/customer/dashboard');
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Track shipments, view invoices & manage bookings</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 text-center text-sm text-gray-500">
            Contact your account manager if you don't have portal access.
          </div>
        </div>
      </div>
    </div>
